"""MÃ n hÃ¬nh chá»n cáº¥p Ä‘á»™ Ä‘á»ƒ ngÆ°á»i chÆ¡i chá»n kÃ­ch thÆ°á»›c bÃ n cá».

File nÃ y chá»‹u trÃ¡ch nhiá»‡m bá»‘ trÃ­ danh sÃ¡ch level theo layout phÃ¹ há»£p vá»›i
tá»· lá»‡ cá»­a sá»• 2:3, Ä‘á»“ng thá»i váº«n tá»± co giÃ£n náº¿u sá»‘ lÆ°á»£ng level thay Ä‘á»•i.
"""
...
class LevelSelectScreen:
    """MÃ n hÃ¬nh cho phÃ©p ngÆ°á»i chÆ¡i chá»n kÃ­ch thÆ°á»›c puzzle trÆ°á»›c khi vÃ o game."""
    ...
    def _compute_grid_columns(self) -> int:
        """Tá»± chá»n sá»‘ cá»™t hiá»ƒn thá»‹ dá»±a trÃªn bá» rá»™ng mÃ n hÃ¬nh."""
        if self.surface_rect.width < 760:
            return 2
        return 3

    def _compute_panel_rect(self, columns: int) -> pygame.Rect:
        """TÃ­nh khung ná»n chá»©a cÃ¡c nÃºt level sao cho vá»«a mÃ n hÃ¬nh."""
    ...
    def _build_level_buttons(self) -> None:
        """Táº¡o láº¡i danh sÃ¡ch nÃºt level theo layout hiá»‡n táº¡i.

        HÃ m nÃ y gom toÃ n bá»™ logic tÃ­nh vá»‹ trÃ­ nÃºt Ä‘á»ƒ pháº§n draw chá»‰ táº­p trung
        vÃ o viá»‡c váº½, khÃ´ng pháº£i tá»± tÃ­nh toÃ¡n layout láº·p láº¡i.
        """
    ...
    def handle_event(self, event: pygame.event.Event) -> Transition:
        """Báº¯t sá»± kiá»‡n click cá»§a nÃºt Back vÃ  cÃ¡c nÃºt level."""
    ...
    def draw(self, surface: pygame.Surface) -> None:
        """Váº½ mÃ n chá»n level theo layout hiá»‡n táº¡i cá»§a cá»­a sá»•."""
        self._build_level_buttons()
